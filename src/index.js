...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        client.on('ready', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, client.setActivity({
                            buttons: [{ label: "github", url: "https://github.com/LaZeAsh" }],
                            details: "Discord Rich Presence Status",
                            largeImageKey: "rpc",
                            largeImageText: "Hello there"
                        })
        ...
        client.login({ clientId: process.env.APPLICATION_ID }).catch(function (error) {
            console.log(error);
        });
        return [2 /*return*/];
    });
